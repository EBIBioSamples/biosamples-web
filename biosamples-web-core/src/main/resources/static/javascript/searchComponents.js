...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/Applications/MAMP/htdocs/clonedAfterChanges/biosamples-web/biosamples-web-core/src/main/frontend/js/components/itemsDropdown/ItemsDropdown.vue"
  if (!module.hot.data) {
  ...
  if (typeof results !== 'undefined') {
    ...
    if (!(Object.keys(numberFacetsUnEmpty).length === 0 && JSON.stringify(obj) === JSON.stringify({}))) {
      ...
      //  +'<div class="col-md-6"> <component is="items-dropdown"> </component> </div>'
       + '</div>' + ' <h3>Clicked element information</h3>' + '<div id="textData"> <p> Click on an element of the diagram to display its information </p> </div>';
