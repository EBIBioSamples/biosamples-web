        ...
        this.$http.get(server, queryParams).then(function (results) {
          ...
          */
          ...
          if (document.getElementById("vizSpotRelations") === null) {
            ...
            //.attr("width", "100%")
            .attr("width", "60%").attr("height", heightD3).attr("id", "vizSpotRelations")
            //.style("stroke", "black")
            .style("stroke", "green").style("stroke-width", 1).style("border", "solid").style("overflow", "scroll").style("border-color", "#5D8C83").style("border-radius", "10px").call(d3.behavior.zoom().on("zoom", function (d) {
              /*
            ...
            //console.log("vizSpotRelations null and svg : ");console.log(svg);
              ...
              svg = d3.select(".container").insert("svg", ":first-child")
              //.attr("width", "100%")
              .attr("width", "60%").attr("height", heightD3).attr("id", "vizSpotRelations").style("stroke", "black").style("stroke-width", 1).style("border", "solid").style("overflow", "scroll").style("border-color", "#5D8C83").style("border-radius", "10px").call(d3.behavior.zoom().on("zoom", function (d) {
                //console.log("onzoom d : ");console.log(d);
                //console.log("onzoom d3 : ");console.log(d3);
