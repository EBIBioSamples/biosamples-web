...
},{"lodash":2}],31:[function(require,module,exports){
"use strict";
...
},{"./facetlist.template.html":33}],33:[function(require,module,exports){
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/Applications/MAMP/htdocs/biosamples-web/src/main/frontend/js/components/itemsDropdown/ItemsDropdown.vue"
  if (!module.hot.data) {
...
},{"underscore":3,"vue":29,"vue-hot-reload-api":4}],35:[function(require,module,exports){
'use strict';
...
},{"./alternative.pagination.template.html":36,"lodash":2}],36:[function(require,module,exports){
...
},{"./product.template.html":38,"lodash":2}],38:[function(require,module,exports){
...
function doD3Stuff(results, server) {
  ...
  if (typeof results !== 'undefined') {
    ...
    if (!(Object.keys(numberFacetsUnEmpty).length === 0 && JSON.stringify(obj) === JSON.stringify({}))) {
      ...
      for (var u in numberFacetsUnEmpty) {
        if (numberFacetsUnEmpty[u] > 0) {
          strResults += '<td>  <div id="infoVizRelations' + cpt + '" height=' + document.getElementById("infoVizRelations").getBoundingClientRect().height / 3 + ' overflow=scroll; overflow-x=visible  > </div>   </td>';
        }
        cpt++;
      }
      strResults += '</tr> </table>';
    ...
    for (var u in numberFacetsUnEmpty) {
      if (numberFacetsUnEmpty[u] > 0) {
        ...
        }).attr("height", height).attr("id", "resultsViz" + cpt + "").attr("class", "bar").style("stroke", "black").style("stroke-width", 1).style("border", "solid").style("border-color", "#5D8C83").style("border-radius", "10px"));
      }
      cpt++;
    }
    ...
    if (document.getElementById("vizSpotRelations") === null) {
      svg = d3.select(".container").insert("svg", ":first-child").attr("width", "60%").attr("height", heightD3).attr("id", "vizSpotRelations").style("stroke", "green").style("stroke-width", 1).style("border", "solid").style("overflow", "scroll").style("background-color", "#f5f5f5").style("border-color", "#5D8C83").style("border-radius", "4px").on("mouseenter", function () {
        document.getElementById("elementHelp").style.visibility = "visible";
      ...
      svg = d3.select(".container").insert("svg", ":first-child").attr("width", "60%").attr("height", heightD3).attr("id", "vizSpotRelations").style("stroke", "black").style("stroke-width", 1).style("border", "solid").style("overflow", "scroll").style("border-color", "#5D8C83").style("border-radius", "4px").on("mouseenter", function () {
        document.getElementById("elementHelp").style.visibility = "visible";
        d3.select("#elementHelp").html("Help <hr/> Hover over a node to make it bigger. <br/> Click on a node to display its information.");
      }).on("mouseleave", function () {
        document.getElementById("elementHelp").style.visibility = "hidden";
...
},{"./components/Biosample.js":30,"./components/badge/Badge.js":31,"./components/facetList/FacetList.js":32,"./components/itemsDropdown/ItemsDropdown.vue":34,"./components/pagination/Pagination.js":35,"./components/productsList/ProductsList.js":39,"./filters/excerptFilter.js":41,"./utilities/_mixins.js":43,"lodash":2,"vue":29,"vue-resource":18}],43:[function(require,module,exports){
'use strict';
